...
```{r}
county_map <- tm_shape(sj) +
  tm_borders() +
  tm_shape(combined_unique) +
  tm_polygons(col = "opc_tile",
          midpoint = 3,
          #style = "order", # close to quantile style
          colorNA = "grey50",
          pal = "viridis",
...
# Save static map 
tmap_save(county_map, file = here("outputs", "us_county_map.png"))
```