...
org_activities_mbf <- org_activities_mbf %>%
  ...
  dplyr::select(ein, state, city, zip, take_action, volunteer, membership, events, website, grouping_value, is_po, fips)
```
...
org_activities_mbf$website %>% sum() / nrow(org_activities_mbf)
