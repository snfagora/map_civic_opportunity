...
opc_full <- lm(has_hubs ~ opc + Age65AndOlderPct2010 + WhiteNonHispanicPct2010 + AsianNonHispanicPct2010 + BlackNonHispanicPct2010 + HispanicPct2010 + NativeAmericanNonHispanicPct2010 + per_col_ed + PCTPOVALL + RUCC + gop.tier, mut.aid %>% filter(!is.na(opc),!is.na(civic_organizations_county),!is.na(socialcap), !is.na(sk2014)))
kyne_full<- lm(has_hubs ~ socialcap + Age65AndOlderPct2010 + WhiteNonHispanicPct2010 + AsianNonHispanicPct2010 + BlackNonHispanicPct2010 + HispanicPct2010 + NativeAmericanNonHispanicPct2010 + per_col_ed + PCTPOVALL + RUCC + gop.tier, mut.aid %>% filter(!is.na(opc),!is.na(civic_organizations_county),!is.na(socialcap), !is.na(sk2014)))
chetty_full <- lm(has_hubs ~ civic_organizations_county + Age65AndOlderPct2010 + WhiteNonHispanicPct2010 + AsianNonHispanicPct2010 + BlackNonHispanicPct2010 + HispanicPct2010 + NativeAmericanNonHispanicPct2010 + per_col_ed + PCTPOVALL + RUCC + gop.tier, mut.aid %>% filter(!is.na(opc),!is.na(civic_organizations_county),!is.na(socialcap), !is.na(sk2014)))
penn_full <- lm(has_hubs ~ sk2014 + Age65AndOlderPct2010 + AsianNonHispanicPct2010 + WhiteNonHispanicPct2010 + BlackNonHispanicPct2010 + HispanicPct2010 + NativeAmericanNonHispanicPct2010 + per_col_ed + PCTPOVALL + RUCC + gop.tier, mut.aid %>% filter(!is.na(opc),!is.na(civic_organizations_county),!is.na(socialcap), !is.na(sk2014)))
